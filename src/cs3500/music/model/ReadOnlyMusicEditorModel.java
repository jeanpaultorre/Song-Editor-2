...
public class ReadOnlyMusicEditorModel implements IMusicEditorModel {
  ...
  //JEAN PAUL MAKE SURE TO MOVE THIS SOMEWHERE ELSE
  @Override
  public void updateTempo(int change) {
    throw new IllegalArgumentException("EXTRA CREDIT MAKE SURE TO MOVE SOMEWHERE ELSE");
  }

  @Override
  public List<Repeat> loRepeat() {
    return model.loRepeat();
  }

  @Override
  public List<Repeat> loEndings() {
    return model.loEndings();
  }
