  ...
  public static <T> T parseFile(Readable readable, CompositionBuilder<T> piece) {
    ...
    while (scanner.hasNext()) {
      ...
      switch (lineType) {
        ...
        case "repeat":
          try {
            int startRepeat = scanner.nextInt();
            int endRepeat = scanner.nextInt();
            piece.addRepeat(startRepeat, endRepeat);
          }catch (NoSuchElementException e) {
        ...
        case "ending":
          try {
            int startEnding = scanner.nextInt();
            int endEnding = scanner.nextInt();
            piece.addEnding(startEnding, endEnding);
          }catch (NoSuchElementException e) {
...
//JEAN PAUL COULD MAYBE USE A DECORATOR?