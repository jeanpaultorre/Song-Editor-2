...
public class GuiViewFrame extends JFrame implements IView {
  ...
  private PianoGuiView piano2;
  private JScrollPane scrollPane;
  private final JPanel piano;
  ...
  public Note currentNoteAtPoint(Point mouse) {
    ...
    //return piano.currentNoteAtPoint();
//    System.out.println(piano.getMousePosition());
//    System.out.println(piano2.currentNoteAtPoint(mouse);
    return piano2.currentNoteAtPoint(mouse);
  }
