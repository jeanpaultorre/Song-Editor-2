...
public class CompositeView implements ISuperIView {
  ...
  public Point currentMousePosition() {
   // System.out.println(gui.getMousePosition());
  ...
  //BAD DESIGN PUT IN ANOTHER INTERFACE

  /**
   * Updates the practice Note.
   * @param mouse
   */
  public void updatePracticeNote(Point mouse) {
    gui.updatePracticeNote(mouse);
  }

  /**
   * gets the currentSize of the practice Notes.
   * @return
   */
  @Override
  public int currentSize() {
    return gui.currentSize();
  }

  /**
   * Lets the user know if they were sucessful in the practice mode.
   * @return
   */
  public boolean completePractice() {
    return gui.completePractice();
  }
}
